-- ============================================================
-- Ledger — Supabase schema for CLERK login (kept for the future switch)
-- Only needed if/when the app moves from Supabase Auth to Clerk.
-- For the current Supabase email/password login, use schema.sql.
--
-- Login lives in Clerk. Every request arrives with a Clerk-signed
-- JWT (via the "supabase" JWT template in the Clerk dashboard)
-- and user_id holds the Clerk user id (e.g. user_2abc…).
-- ============================================================
...
-- ============================================================
-- Row Level Security — the JWT's "sub" claim is the Clerk user
-- id, so every user can only ever see their own rows.
-- ============================================================
